 ...
 */
  ...
  EyebrowRegular: 'text-11.67px lg:text-13.33px leading-6 font-normal font-2 uppercase',
  EyebrowBold: 'text-11.67px lg:text-13.33px leading-6 font-bold font-2 uppercase',
